...
@RestController
@RequestMapping("/locationde")
public class LocationDEController {
    @Autowired
    ...
    public ResponseEntity<ResponseDTO> getAllLocations(){
        return new ResponseEntity<ResponseDTO>(new ResponseDTO(200,
                locationDEService.getLocationsdepets(),null), HttpStatus.OK);
    }

    @GetMapping(path = "/countries")
    public ResponseEntity<ResponseDTO> getCountries(){
        return new ResponseEntity<ResponseDTO>(new ResponseDTO(200,
                locationDEService.getLocationsDEByCodeSize(3),null), HttpStatus.OK);
    }

    @GetMapping(path = "/departments")
    public ResponseEntity<ResponseDTO> getDepartments(){
        return new ResponseEntity<ResponseDTO>(new ResponseDTO(200,
                locationDEService.getLocationsDEByCodeSize(5),null), HttpStatus.OK);
    }
}
